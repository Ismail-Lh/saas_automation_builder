    ...
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center ">
        ...
        >
          ...
          <div className="absolute  bottom-0 left-0 z-20 h-full  w-40 bg-neutral-950 [mask-image:linear-gradient(to_right,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: '15rem' }}
          whileInView={{ opacity: 1, width: '30rem' }}
        ...
        >
          <div className="absolute  bottom-0 right-0 z-20 h-full  w-40 bg-neutral-950 [mask-image:linear-gradient(to_left,white,transparent)]" />
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-24 rounded-full bg-neutral-400 blur-2xl"
        />
        <motion.div
          initial={{ width: '15rem' }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-28 bg-neutral-400 "
        />
